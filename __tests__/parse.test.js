...
test('Correct_json_.json_1', () => {
  ...
  const expected = [{
    key: 'common',
    type: 'nested',
    children: [{ key: 'follow', type: 'added', value: false },
      ...
      { key: 'setting5', type: 'added', value: { key5: 'value5' } },
      {
        key: 'setting6',
        type: 'nested',
        children: [{ key: 'doge', type: 'nested', children: [{ key: 'wow', type: 'updated', oldValue: '', newValue: 'so much' }] },
  ...
  },
  {
    key: 'group1',
    type: 'nested',
    children: [{ key: 'baz', type: 'updated', oldValue: 'bas', newValue: 'bars' }, { key: 'foo', type: 'unchanged', value: 'bar' },
      { key: 'nest', type: 'updated', oldValue: { key: 'value' }, newValue: 'str' }],
  }, { key: 'group2', type: 'removed', value: { abc: 12345, deep: { id: 45 } } },
  { key: 'group3', type: 'added', value: { deep: { id: { number: 45 } }, fee: 100500 } }]
  expect(JSON.parse(fileTypeDefinition(filePath1, filePath2, 'json'))).toEqual(expected)
})
...
test('Correct_json_.json_2', () => {
  ...
  { key: 'group1', type: 'added', value: { baz: 'bars', foo: 'bar', nest: 'str' } }, {
    key: 'group3',
    type: 'added',
